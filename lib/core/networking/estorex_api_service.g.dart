...
class _EStoreXApiService implements EStoreXApiService {
  ...
  @override
  Future<BasketResponseModel?> getBasketByCustomerId(String basketId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BasketResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/Baskets/${basketId}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late BasketResponseModel? _value;
    try {
      _value =
          _result.data == null
              ? null
              : BasketResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> deleteBasketByCustomerId(String basketId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> deleteItemFromBasketByProductId(
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/Baskets/${basketId}/items/${productId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BasketResponseModel> increaseBasketItem(
    ...
    final _options = _setStreamType<BasketResponseModel>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/Baskets/${basketId}/items/${productId}/increase',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late BasketResponseModel _value;
    try {
      _value = BasketResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<BasketResponseModel> decreaseBasketItem(
    ...
    final _options = _setStreamType<BasketResponseModel>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/Baskets/${basketId}/items/${productId}/decrease',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BasketResponseModel> applyDiscount(
    ...
    final _options = _setStreamType<BasketResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/Baskets/${basketId}/apply-discount/${code}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<BasketResponseModel> mergeBasketWithGuestBasket(String guestId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'guestId': guestId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BasketResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
  ...
  @override
  Future<AuthResponseModel> loginUser(LoginRequestModel loginModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthResponseModel> resetPassword(ResetPasswordRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthResponseModel> refreshToken(RefreshTokenRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthResponseModel> externalLogin(String provider) async {
    final _extra = <String, dynamic>{};
  ...
  Future<List<DeliveryOption>> getDeliveryMethods() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<DeliveryOption>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<DeliveryOption> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) =>
                    DeliveryOption.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<List<OrderResponseModel>> getOrders() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<OrderResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/Orders',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<OrderResponseModel> _value;
    try {
      _value =
          _result.data!
              .map(
  ...
  Future<PaymentResponse> getPaymentIntentData(
    ...
    final queryParameters = <String, dynamic>{
      r'basketId': basketId,
      r'deliveryMethodId': deliveryMethodId,
    };
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<List<RatingResponseModel>> getRatingsByProductId(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<RatingResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<RatingResponseModel> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) =>
                    RatingResponseModel.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<RatingSummaryModel> getRatingSummary(String productId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RatingSummaryModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RatingSummaryModel _value;
    try {
      _value = RatingSummaryModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AuthResponseModel> updateUserProfile(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updatedProfileRequest.toJson());
    final _options = _setStreamType<AuthResponseModel>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<List<BrandResponseModel>> getAllBrands() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<BrandResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/brands',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<BrandResponseModel> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) =>
                    BrandResponseModel.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
